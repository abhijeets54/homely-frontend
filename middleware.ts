...
export function middleware(request: NextRequest) {
  ...
  const publicPaths = ['/', '/about', '/contact', '/test-routing', '/sellers'];
  ...
  // Debug logging
  console.log(`Middleware: Path: ${pathname}, Token: ${token ? 'exists' : 'none'}, UserType: ${userType || 'none'}, IsPublicPath: ${isPublicPath}`);
